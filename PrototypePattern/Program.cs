...
namespace PrototypePattern
{
    class Program
    {
        ...
        static void TestDeepCopyAndShallowCopy()
        {
            ...
            DemoClass D = DeepCopy.DeepCopyByReflection<DemoClass>(C);
            D._int = 6;
            Console.WriteLine(" int \t\t  C:{0}  D:{1}", C._int, D._int);

            D._string = "6";
            Console.WriteLine(" string \t  C:{0}  D:{1}", C._string, D._string);

            D._enum = myEnum._6;
            Console.WriteLine(" enum \t\t  C:{0}  D:{1}", (int)C._enum, (int)D._enum);

            D._struct._int = 6;
            Console.WriteLine(" struct \t  C:{0}  D:{1}", C._struct._int, D._struct._int);

            D._class._string = "6";
            Console.WriteLine(" class \t\t  C:{0}  D:{1}", C._class._string, D._class._string);

            D.arrInt[0] = 6;
            Console.WriteLine(" intArray \t  C:{0}  D:{1}", C.arrInt[0], D.arrInt[0]);

            D.arrString[0] = "6";
            Console.WriteLine(" stringArray \t  C:{0}  D:{1}", C.arrString[0], D.arrString[0]);
